...
export const NumberCounting = ({ inProgress, resolved }) => {
  return (
    <div className='flex flex-col md:flex-row items-center justify-center w-full h-auto p-4'>
      ...
      <img src={'/src/assets/vector1.png'} alt='' className='absolute left-0 top-0 h-full object-cover opacity-80' />
        ...
        <h1 className='text-3xl font-bold text-white'>{inProgress.length}</h1>
      </div>
      ...
      <img src={'/src/assets/vector1.png'} alt='' className='absolute left-0 top-0 h-full object-cover opacity-80' />
        ...
        <h1 className='text-3xl font-bold text-white'>{resolved.length}</h1>
      </div>
    </div>
  )
}
